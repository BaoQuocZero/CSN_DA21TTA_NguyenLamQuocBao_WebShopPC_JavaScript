...
class SanPhamASUS extends React.Component {
    ...
    fetchData = async () => {
        try {
            const response = await fetch("http://localhost:8080/api/v1/sanphamASUS", {
                method: "GET",
                mode: "cors",
            });
            if (!response.ok) {
            ...
            <>
                ...
                <div className="relative">
                    <div className="container-bottom">
                        <div className="tieude"><h1>Danh Sách Sản Phẩm ASUS</h1></div>
...
export default withRouter(SanPhamASUS);
